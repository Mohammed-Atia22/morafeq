// src/pages/Login.jsx
// --------------------------------------------------
// Login page — wired to useAuth hook.
// Handles: email/password login + Google OAuth link.
// --------------------------------------------------
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-card-lg p-8 border border-gray-100">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-black text-gray-900 mb-1">أهلاً بك مجدداً</h1>
            <p className="text-gray-400 text-sm font-medium">سجّل دخولك للمتابعة</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <button
              ...
              className="w-full bg-primary-600 hover:bg-primary-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-black py-3.5 rounded-xl transition-all shadow-lg shadow-blue-500/25 active:scale-95 flex items-center justify-center gap-2 text-base"
            >
              {loading ? (
                <>
          ...
          <p className="text-center text-sm text-gray-400 font-medium mt-6">
            ليس لديك حساب؟{" "}
            <Link to="/register" className="text-primary-600 font-bold hover:text-primary-800 transition-colors">
              أنشئ حساباً مجانياً
            </Link>
          </p>
