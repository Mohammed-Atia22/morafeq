  ...
  return (
    <div>
      <div style={sectionTitleStyles}>
        <div>
          <h2 style={{ margin: 0, fontSize: "20px", color: "#12213f" }}>
            تفاصيل الشقة
          </h2>
          <p
            style={{
          ...
          >
            اكمل بيانات الشقة والتجهيزات المطلوبة مثل الإيجار والمساحة.
          </p>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gap: "14px" }}>
        ...
        >
          ...
          >
            ...
            />
            {errors.beds && (
              <span style={{ color: "#dc2626" }}>{errors.beds.message}</span>
            )}
          </label>
          <label
            style={{
        ...
        >
          ...
          >
            تفضيل الجنس
            <select style={fieldStyles} {...register("genderPreference")}>
          ...
          >
            التدخين
            <select style={fieldStyles} {...register("smokingPolicy")}>
      ...
      {roomCount > 0 && roomType !== "ENTIRE_PLACE" && (
        ...
        >
          <div style={{ marginBottom: "14px" }}>
            ...
            >
              يتم إنشاء الغرف تلقائيا حسب عدد الغرف. أضف اسم كل غرفة وسعتها
              وصورها.
            </p>
          </div>
              ...
              return (
                ...
                >
                    ...
                    >
                      ...
                      <input
                        ...
                        {...register(`rooms.${roomIndex}.capacity`, {
                          ...
                          min: {
                            value: 1,
                            message: "السعة يجب أن تكون 1 على الأقل",
                          },
                        })}
                      />
                  ...
                  <div style={{ marginTop: "12px" }}>
                    <ImageUploader
                      images={photos}
                      onImagesChange={(newPhotos, error) => {
                        if (error) {
                          // Handle error if needed
                        }
                        // Convert single file to array for compatibility
                        const filesToAdd = newPhotos.filter(
                          (p) => !photos.includes(p),
                        );
                        if (filesToAdd.length > 0) {
                          handleRoomPhotoChange?.(roomIndex, {
                            target: { files: filesToAdd },
                          });
                        }
                      }}
                      onRemove={(photoIndex) =>
                        removeSelectedRoomPhoto?.(roomIndex, photoIndex)
                      }
                      maxImages={10}
                      maxSize={5 * 1024 * 1024}
                      title="صور الغرفة"
                      helperText="يمكنك إضافة حتى 10 صور للغرفة."
                      uploadText="إضافة صورة للغرفة"
                    />
                  </div>
                </div>
              );
