    ...
    <div>
      <div style={sectionTitleStyles}>
        <div>
          ...
          >
            اكتب بيانات المنطقة ثم اضغط بحث عن الخريطة لتحديد موقع العقار بدقة.
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          />
          {errors.city && (
            <span style={{ color: "#dc2626" }}>{errors.city.message}</span>
          )}
        </label>
        ...
        >
          ...
          />
          {errors.areaName && (
            <span style={{ color: "#dc2626" }}>{errors.areaName.message}</span>
          )}
        </label>
      ...
      <div style={{ marginTop: 12 }}>
        ...
        >
          ...
          <textarea
            ...
            placeholder="أضف أي توجيهات خاصة بالوصول مثل مدخل المبنى، رمز البناية، إلخ"
        ...
        >
          ...
          {mapResult.matchLevel !== "STREET" && (
            <p style={{ margin: "10px 0 0", color: "#b45309" }}>
              الموقع تقريبي. حرّك العلامة على الخريطة لمكان العقار بدقة.
            </p>
          )}
        </div>
      )}
