...
export function OwnerPage() {
  const { activeSection, setActiveSection, logout } = useOutletContext();
      ...
      <div className="min-h-screen ">
        ...
        <main className="min-h-screen px-4 pb-24 pt-5 sm:px-6 lg:px-7 lg:pb-10">
          {activeSection === "add" ? (
            ...
            <DashboardState
              title="هذا القسم قيد التجهيز"
              text="القائمة الجانبية الآن تغيّر محتوى لوحة المالك بدون فتح صفحة منفصلة."
            />
          )}
        </main>
